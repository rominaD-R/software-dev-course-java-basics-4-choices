...
public class CollectionChoiceExercises {
    ...
    public void MakeLoggedInUsersCollection() {
        ...
        // present is ignored and checking if a user is in the collection can be done very quickly.

        HashSet<String> loggedIn = new HashSet<String>();
        loggedIn.add("taiGames");
        loggedIn.add("rome55");
        loggedIn.add("darcy808");
        loggedIn.add("rome55");
    }
    ...
    public void MakeEmployeeAccessCodesCollection() {
        ...
        employees.put("Eian", "156123");
        employees.put("Percy", "156127");
        employees.put("Zoe", "156244");
    }
}
